      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative max-w-6xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, index) => <div key={index} className="relative bg-card p-8 rounded-3xl shadow-medium text-center hover-lift animate-slide-in border border-border" style={{
            animationDelay: `${index * 0.2}s`
                ...
                {/* Action Button */}
                <Button variant="outline" className="border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold px-6 py-3 rounded-xl">
                  {step.action}
                </Button>
              </div>)}
          </div>
        ...
        <div className="bg-primary-deep p-16 rounded-3xl text-center">
          ...
          <Button size="lg" className="bg-orange-gradient hover:bg-secondary-light text-white px-12 py-6 text-xl font-bold rounded-2xl hover-lift shadow-orange">
            Apply Now
